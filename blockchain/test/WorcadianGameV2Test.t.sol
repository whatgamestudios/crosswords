...
contract WorcadianGameV2Test is Test {
    WorcadianGameV2 game;
    ...
    function setUp() public {
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(
            ...
            abi.encodeCall(
                ...
                (admin, ownerAddr, upgradeAdmin, address(passportWallet), address(mockSeed), address(mockWordList))
            )
        );
        ...
        game = WorcadianGameV2(address(proxy));
    ...
    function test_GetResults_NoSubmissions_ReturnsZerosAndEmptyArray() public view {
        (uint256 numSubmissions, uint256 bestScore, WorcadianGameV1.Submission[] memory submissions) =
    ...
    function test_GetResults_AfterOneSubmission_MatchesStoredState() public {
        ...
        WorcadianGameV1.Submission[] memory bestViaV1 = game.getBestSubmissions(GAME_DAY);
