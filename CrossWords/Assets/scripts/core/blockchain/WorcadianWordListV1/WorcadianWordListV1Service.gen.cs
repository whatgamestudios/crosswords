...
namespace CrossWords.WorcadianWordListV1
{
    public partial class WorcadianWordListV1Service: WorcadianWordListV1ServiceBase
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.IWeb3 web3, WorcadianWordListV1Deployment worcadianWordListV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<WorcadianWordListV1Deployment>().SendRequestAndWaitForReceiptAsync(worcadianWordListV1Deployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.IWeb3 web3, WorcadianWordListV1Deployment worcadianWordListV1Deployment)
        {
            return web3.Eth.GetContractDeploymentHandler<WorcadianWordListV1Deployment>().SendRequestAsync(worcadianWordListV1Deployment);
        }

        public static async Task<WorcadianWordListV1Service> DeployContractAndGetServiceAsync(Nethereum.Web3.IWeb3 web3, WorcadianWordListV1Deployment worcadianWordListV1Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, worcadianWordListV1Deployment, cancellationTokenSource);
            return new WorcadianWordListV1Service(web3, receipt.ContractAddress);
        }

        public WorcadianWordListV1Service(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
    ...
    public partial class WorcadianWordListV1ServiceBase: ContractWeb3ServiceBase
    {

        public WorcadianWordListV1ServiceBase(Nethereum.Web3.IWeb3 web3, string contractAddress) : base(web3, contractAddress)
        {
        }
        ...
        public virtual Task<string> AddWordsRequestAsync(AddWordsFunction addWordsFunction)
        {
             return ContractHandler.SendRequestAsync(addWordsFunction);
        }

        public virtual Task<TransactionReceipt> AddWordsRequestAndWaitForReceiptAsync(AddWordsFunction addWordsFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(addWordsFunction, cancellationToken);
        }

        public virtual Task<string> AddWordsRequestAsync(List<byte[]> words)
        {
            var addWordsFunction = new AddWordsFunction();
                addWordsFunction.Words = words;
            
             return ContractHandler.SendRequestAsync(addWordsFunction);
        }

        public virtual Task<TransactionReceipt> AddWordsRequestAndWaitForReceiptAsync(List<byte[]> words, CancellationTokenSource cancellationToken = null)
        {
            var addWordsFunction = new AddWordsFunction();
                addWordsFunction.Words = words;
        ...
        public Task<bool> InWordListQueryAsync(InWordListFunction inWordListFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<InWordListFunction, bool>(inWordListFunction, blockParameter);
        }

        
        public virtual Task<bool> InWordListQueryAsync(byte[] word, BlockParameter blockParameter = null)
        {
            var inWordListFunction = new InWordListFunction();
                inWordListFunction.Word = word;
            
            return ContractHandler.QueryAsync<InWordListFunction, bool>(inWordListFunction, blockParameter);
        }

        public Task<List<bool>> InWordListBulkQueryAsync(InWordListBulkFunction inWordListBulkFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<InWordListBulkFunction, List<bool>>(inWordListBulkFunction, blockParameter);
        }

        
        public virtual Task<List<bool>> InWordListBulkQueryAsync(List<byte[]> words, BlockParameter blockParameter = null)
        {
            var inWordListBulkFunction = new InWordListBulkFunction();
                inWordListBulkFunction.Words = words;
        ...
        public virtual Task<string> RemoveWordRequestAsync(RemoveWordFunction removeWordFunction)
        {
             return ContractHandler.SendRequestAsync(removeWordFunction);
        }

        public virtual Task<TransactionReceipt> RemoveWordRequestAndWaitForReceiptAsync(RemoveWordFunction removeWordFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(removeWordFunction, cancellationToken);
        }

        public virtual Task<string> RemoveWordRequestAsync(byte[] word)
        {
            var removeWordFunction = new RemoveWordFunction();
                removeWordFunction.Word = word;
            
             return ContractHandler.SendRequestAsync(removeWordFunction);
        }

        public virtual Task<TransactionReceipt> RemoveWordRequestAndWaitForReceiptAsync(byte[] word, CancellationTokenSource cancellationToken = null)
        {
            var removeWordFunction = new RemoveWordFunction();
                removeWordFunction.Word = word;
        ...
        public override List<Type> GetAllFunctionTypes()
        {
            return new List<Type>
            {
                ...
                typeof(InWordListFunction),
                typeof(InWordListBulkFunction),
                typeof(InitializeFunction),
                typeof(OwnerFunction),
                typeof(ProxiableUUIDFunction),
                typeof(RemoveWordFunction),
        ...
        public override List<Type> GetAllEventTypes()
        {
            return new List<Type>
            {
                ...
                typeof(WordRemovedEventDTO),
                typeof(WordsAddedEventDTO)
            };
        }
