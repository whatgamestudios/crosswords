 ...
 */
contract WordListSeedV2 is AccessControlEnumerableUpgradeable, UUPSUpgradeable {
    ...
    function resetSeedWords() external virtual onlyRole(WORDSMITH_ROLE) {
        delete _seedWords;
    }
    function changeSeedWord(uint256 _ofs, string calldata _newWord) external virtual onlyRole(WORDSMITH_ROLE) {
        _seedWords[_ofs] = _newWord;
    }
